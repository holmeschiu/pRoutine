...
tif_file_root="avb8_042318_1_"
mrc_file_root="avb8_1804_"
gain_reference="gainref_transformed.mrc"
start_number=3000
end_number=3999
super_pixel_size=0.5250
frame_dose=1.5756
...
-Gpu 0 1 2 >> ${mrc_file_root}${file_number}_motioncor2log.txt
        ...
        if (( $(echo "$error_rate_threshold < $error_rate" | bc -l) )); then
            echo "The image of ${file_number} has a large alignment error rate. -- ${error_rate}"
        fi
